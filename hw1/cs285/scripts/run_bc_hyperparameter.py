...
class BC_Trainer(object):
    ...
    def __init__(self, params, logger= None):
        ...
        self.rl_trainer = RL_Trainer(self.params, logger) ## TODO: look in here and implement this
...
def main():
    ...
    for i in range(10):
        params['train_batch_size'] = 30*(i+1)
        trainer = BC_Trainer(params, logger)
        log = trainer.run_training_loop()
        logger.log_scalar(log['Eval_AverageReturn'], 'Eval_', 30*(i+1))
